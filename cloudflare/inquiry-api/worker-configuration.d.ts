/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8d049c8ca0ea9596422a2860b21fa683)
// Runtime types generated with workerd@1.20260708.1 2026-07-08 nodejs_compat
interface __BaseEnv_Env {
	INQUIRY_EMAIL: SendEmail;
	INQUIRY_CONTACT_RATE_LIMIT: RateLimit;
	INQUIRY_EDGE_RATE_LIMIT: RateLimit;
	...
	INQUIRY_RECIPIENT: "qianjiabao1999@gmail.com";
	INQUIRY_FROM: "inquiry@jabbarsourcing.com";
	PRIVACY_VERSION: "2026-07-12";
	INQUIRY_IDEMPOTENCY: DurableObjectNamespace<import("./src/index").InquiryIdempotency>;
	TURNSTILE_SITEVERIFY: Fetcher /* turnstile-siteverify-jabbar-sourcing */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "InquiryIdempotency";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGINS" | "ALLOWED_HOSTNAMES" | "INQUIRY_RECIPIENT" | "INQUIRY_FROM" | "PRIVACY_VERSION">> {}
}
