(function () {
  ...
  var labels = {
    zh: ["语言", "关闭提示", "已从体积工具带入计算结果，请确认并补充询盘信息。"],
    en: ["Language", "Dismiss notice", "Your calculator result has been added. Review it and complete your inquiry."],
    es: ["Idioma", "Cerrar aviso", "El resultado de la calculadora se ha añadido. Revísalo y completa tu solicitud."],
    ar: ["اللغة", "إغلاق التنبيه", "تمت إضافة نتيجة الحاسبة. راجعها وأكمل تفاصيل طلبك."],
    fr: ["Langue", "Fermer l’avis", "Le résultat du calculateur a été ajouté. Vérifiez-le et complétez votre demande."],
    pt: ["Idioma", "Fechar aviso", "O resultado da calculadora foi adicionado. Revise e complete sua consulta."],
    ru: ["Язык", "Закрыть уведомление", "Результат расчета добавлен. Проверьте его и заполните запрос."],
    de: ["Sprache", "Hinweis schließen", "Das Rechnergebnis wurde übernommen. Prüfen und vervollständigen Sie Ihre Anfrage."],
    it: ["Lingua", "Chiudi avviso", "Il risultato del calcolatore è stato aggiunto. Controllalo e completa la richiesta."],
    tr: ["Dil", "Bildirimi kapat", "Hesaplama sonucu eklendi. Sonucu kontrol edip talebinizi tamamlayın."]
  };
  ...
  function initCalculatorPrefillNotice() {
    ...
    dismiss.type = "button";
    dismiss.setAttribute("aria-label", copy[1]);
    dismiss.title = copy[1];
    dismiss.addEventListener("click", function () { notice.remove(); });
    notice.appendChild(element("span", "calculator-prefill-notice-text", copy[2]));
